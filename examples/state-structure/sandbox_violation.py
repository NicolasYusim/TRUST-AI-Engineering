# Scope & Structure agent — negative teaching example; do not copy into production.
# Evidence label: illustrative. Numeric limits mentioned in this file are absent
# or unsupported on purpose and demonstrate the violation.
