# Utility & Bounds — negative teaching example; do not copy into production.
# Evidence label: illustrative. Every number, price, ratio, and saving in this
# file is intentionally unsupported and demonstrates the violation.
