# Testability & Oversight — negative teaching example; do not copy.
# This is explicitly an unsafe medical anti-example, not medical guidance or a
# deployable triage design.
# Evidence label: illustrative. Every threshold and metric is intentionally
# unsupported and demonstrates the violation.
