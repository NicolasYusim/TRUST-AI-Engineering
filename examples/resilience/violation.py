# Resilience — negative teaching example; do not copy into production.
# Evidence label: illustrative. Every number and cost comparison in this file is
# intentionally unsupported and demonstrates the violation.
